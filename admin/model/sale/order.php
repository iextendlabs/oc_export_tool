	...
	public function getEmailsByProductsOrdered($products, $start, $end) {
		...
		return $query->rows;
				...
				public function getAllOrders() {
					...
					$query = $this->db->query("SELECT o.order_id, CONCAT(o.firstname, ' ', o.lastname) AS customer_name, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id) AS order_status, CONCAT(o.currency_code, ' ', o.total) AS total_amount ,o.email , o.payment_method,o.shipping_city, o.date_added, o.date_modified FROM " . DB_PREFIX . "order o");
