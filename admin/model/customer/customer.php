	...
	public function getTotalLoginAttempts($email) {
		...
		return $query->row;
				...
				public function getAllCustomers(){
					$query = $this->db->query("SELECT c.customer_id, cgd.name AS group_name,c.firstname,c.lastname,c.email,c.telephone, c.date_added FROM " . DB_PREFIX . "customer c LEFT JOIN " . DB_PREFIX . "customer_group_description cgd ON (c.customer_group_id = cgd.customer_group_id)");
