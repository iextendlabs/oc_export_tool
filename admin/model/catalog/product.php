...
class ModelCatalogProduct extends Model {
	...
	public function getAllProducts() {
		$query = $this->db->query("SELECT DISTINCT p.product_id, pd.name AS product_name, cd.name AS category_name, p.model,p.image, p.quantity, p.price, p.status, p.date_added ,p.date_modified FROM " . DB_PREFIX . "product p LEFT JOIN " . DB_PREFIX . "product_description pd ON(p.product_id = pd.product_id) LEFT JOIN " . DB_PREFIX . "product_to_category pc ON (p.product_id = pc.product_id) LEFT JOIN " . DB_PREFIX . "category_description cd ON (pc.category_id = cd.category_id)");
