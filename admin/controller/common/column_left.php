		...
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($report) {
				...
				// export
					...
					if ($this->user->hasPermission('access', 'catalog/category')) {
						$export[] = array(
							'name'	   => $this->language->get('text_export_category'),
							'href'     => $this->url->link('catalog/category/export', 'user_token=' . $this->session->data['user_token'], true),
							'children' => array()
						);
					}
					...
					if ($this->user->hasPermission('access', 'catalog/product')) {
						$export[] = array(
							...
							'href'     => $this->url->link('catalog/product/export', 'user_token=' . $this->session->data['user_token'], true),
							'children' => array()
						);
					}
					...
					if ($this->user->hasPermission('access', 'sale/order')) {
						$export[] = array(
							'name'	   => $this->language->get('text_export_order'),
							'href'     => $this->url->link('sale/order/export', 'user_token=' . $this->session->data['user_token'], true),
							'children' => array()
						);
					}
					...
					if ($this->user->hasPermission('access', 'customer/customer')) {
						$export[] = array(
							'name'	   => $this->language->get('text_export_customer'),
							'href'     => $this->url->link('customer/customer/export', 'user_token=' . $this->session->data['user_token'], true),
							'children' => array()
						);
					}
