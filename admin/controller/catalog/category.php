...
class ControllerCatalogCategory extends Controller {
	...
	protected function getList() {
		...
		$data['order'] = $order;
				...
				$data['href_export'] = $this->url->link('catalog/category/export', 'user_token=' . $this->session->data['user_token'] .$url, true);
	...
	protected function validateRepair() {
		...
		return !$this->error;
				...
				public function export(){
					...
					$header = array('Category Id','Parent Id','Name');
					...
					foreach ($results as $result) {
						...
						$export_data = array();
						$export_data[]= $result['category_id'];
						$export_data[]= $result['parent_id'];
						$export_data[]= $result['name'];
