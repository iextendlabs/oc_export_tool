...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		$data['order'] = $order;
				...
				$data['href_export'] = $this->url->link('catalog/product/export', 'user_token=' . $this->session->data['user_token'] .$url, true);
	...
	protected function validateCopy() {
		...
		return !$this->error;
				...
				public function export(){
					...
					$header = array('Product id','Name','Category','Model','Image','Quantity','Price','Status','Date Added','date_modified');
