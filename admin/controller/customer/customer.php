...
class ControllerCustomerCustomer extends Controller {
	...
	protected function getList() {
		...
		$data['customer_groups'] = $this->model_customer_customer_group->getCustomerGroups();
				...
				$data['href_export'] = $this->url->link('customer/customer/export', 'user_token=' . $this->session->data['user_token'] .$url, true);
	...
	public function customfield() {
		...
		$this->response->setOutput(json_encode($json));
				...
				public function export(){
					...
					$header = array('Customer Id','Group Name','Firstname','Lastname','Email','Telephone','Date Added');

					fputcsv($file,$header);

					

					$results = $this->model_customer_customer->getAllCustomers();
					foreach ($results as $result) {
						
						$export_data = array();
						$export_data[]= $result['customer_id'];
						$export_data[]= $result['group_name'];
						$export_data[]= $result['firstname'];
						$export_data[]= $result['lastname'];
						$export_data[]= $result['email'];
						$export_data[]= $result['telephone'];
